...
const techniques: MitreTechnique[] = [
  ...
  { id: 'T1557', name: 'Adversary-in-the-Middle', tactic: 'Credential Access', description: 'AitM attacks to intercept credentials', severity: 'critical', detectionCoverage: 96, preventionCoverage: 95, automatedTest: true, lastTested: '2026-03-13', testResult: 'passed', apexAegisModule: 'AegisRoute™ Apexphalanx + SSL' },
