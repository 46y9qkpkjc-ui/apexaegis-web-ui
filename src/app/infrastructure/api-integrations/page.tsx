...
const demoIntegrations: VendorIntegration[] = [
  { id: 'int-001', vendor: 'cisco_ise', label: 'ISE Primary (SG)', host: 'ise-primary.corp.local', port: 9060, api_key: '••••••••••••••••••••••••', username: 'apexaegis-readonly', verify_ssl: true, status: 'connected', last_sync: '2026-03-14T11:30:00Z', log_types: ['RADIUS Authentication', 'TACACS+ Authorization', 'Posture Assessment', 'Guest Portal'], sync_interval_mins: 5, total_logs_synced: 284_319, enabled: true },
  { id: 'int-002', vendor: 'meraki', label: 'Meraki Org (Production)', host: 'api.meraki.com', port: 443, api_key: '••••••••••••••••••••••••', username: '', verify_ssl: true, status: 'connected', last_sync: '2026-03-14T11:28:00Z', log_types: ['Client Association', 'Splash Auth', 'Air Marshal', 'Security Events'], sync_interval_mins: 5, total_logs_synced: 152_871, enabled: true },
  ...
  { id: 'int-004', vendor: 'ubiquiti', label: 'UNMS (Warehouse)', host: 'unms.corp.local', port: 443, api_key: '••••••••••••••••••••••••', username: '', verify_ssl: true, status: 'error', last_sync: '2026-03-14T09:15:00Z', log_types: ['Device Events', 'Client Auth'], sync_interval_mins: 15, total_logs_synced: 12_440, enabled: true },
];
