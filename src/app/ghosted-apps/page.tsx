  ...
  const comparisons: Record<string, { comparisons: FeatureComparison[]; prosCons: ProCon[] }> = {
    ...
    'SWG & SSL Inspection': {
      comparisons: [
        ...
        { feature: 'Global Backbone (PoPs)', apexAegis: { supported: true, maturity: 'production', notes: 'NextGenNodes partnership — 428 PoPs in 362 cities across 5 regions' }, competitor: { supported: true, maturity: 'production', notes: '150+ data centers — no carrier backbone' }, verdict: 'apex-better' },
        { feature: 'AegisRoute™ Path-Aware Networking', apexAegis: { supported: true, maturity: 'production', notes: 'Apexphalanx-based with sovereign ISDs, DRKey auth, zero BGP-hijack risk' }, competitor: { supported: false, maturity: 'none', notes: 'Standard BGP routing — no path awareness or verification' }, verdict: 'apex-better' },
      ...
      prosCons: [
        { product: 'ApexAegis', pros: ['All-in-one SSE + SD-WAN + microsegmentation', 'NextGenNodes backbone — 428 PoPs in 362 cities, 148 Tbps global capacity', 'AegisRoute™ path-aware networking — cryptographic path verification, sovereign isolation domains, zero BGP-hijack risk', 'MASQUE/QUIC dual-path tunnel over Apexphalanx-secured MPLS backbone', 'Lower total cost — no separate add-on licenses', 'Built-in attack path visualization'], cons: ['Expanding rapidly — 428 PoPs operational via NextGenNodes partnership, enterprise adoption accelerating', 'Community growing — backed by Singtel, Apexphalanx Association, and MITRE partnerships'] },
    ...
    'DNS Filtering': {
      comparisons: [
        ...
        { feature: 'Global DNS PoP Infrastructure', apexAegis: { supported: true, maturity: 'production', notes: 'NextGenNodes 428 PoPs — DNS resolved at nearest PoP via AegisRoute™' }, competitor: { supported: true, maturity: 'production', notes: 'Umbrella anycast DNS — no carrier backbone' }, verdict: 'apex-better' },
      ],
      prosCons: [
        { product: 'ApexAegis', pros: ['DNS filtering + full SWG + DLP in one agent', 'No port 53 conflict when it is the sole DNS handler', 'Unified policy engine', 'NextGenNodes backbone — DNS resolved at closest of 428 PoPs across 362 cities', 'AegisRoute™ ensures DNS queries never traverse untrusted ASes'], cons: ['DNS intel: accelerated via Farsight DNSDB & DomainTools partnerships — scaling to Umbrella parity'] },
    ...
    'ZTNA & Tunnel': {
      comparisons: [
        ...
        { feature: 'AegisRoute™ Path-Aware Backbone', apexAegis: { supported: true, maturity: 'production', notes: 'Apexphalanx over MPLS — NextGenNodes 428 PoPs, cryptographic path verification, sovereign ISDs' }, competitor: { supported: false, maturity: 'none', notes: 'Standard BGP routing — no path awareness or sovereign isolation' }, verdict: 'apex-better' },
        { feature: 'Carrier-Grade PoP Infrastructure', apexAegis: { supported: true, maturity: 'production', notes: '362 cities, 148 Tbps capacity, 46 MPLS rings via NextGenNodes partnership' }, competitor: { supported: true, maturity: 'production', notes: 'Palo Alto cloud — co-located DCs, no carrier backbone ownership' }, verdict: 'apex-better' },
      ],
      prosCons: [
        { product: 'ApexAegis', pros: ['Modern MASQUE/QUIC tunnel protocol', 'Dual-path bonding (Wi-Fi + cellular)', 'Integrated SWG — no split-tunnel needed', 'Lower MTU overhead with QUIC', 'AegisRoute™ — path-aware networking with cryptographic path verification over NextGenNodes MPLS backbone', 'NextGenNodes partnership — 428 PoPs in 362 cities, tunnels route over sovereign Apexphalanx isolation domains', 'Zero BGP-hijack risk — every hop cryptographically validated, no hidden transit ASes'], cons: ['Newer protocol — rapidly proven via Singtel global deployment'] },
    ...
    'SWG & CASB & DLP': {
      comparisons: [
        ...
        { feature: 'Tunnel (MASQUE/QUIC)', apexAegis: { supported: true, maturity: 'production', notes: 'Modern dual-path tunnel over Apexphalanx backbone' }, competitor: { supported: true, maturity: 'production', notes: 'GRE/IPSec tunnel' }, verdict: 'apex-better' },
        { feature: 'AegisRoute™ / Carrier Backbone', apexAegis: { supported: true, maturity: 'production', notes: 'NextGenNodes 428 PoPs, 362 cities — Apexphalanx over MPLS with sovereign ISDs' }, competitor: { supported: false, maturity: 'none', notes: 'NewEdge co-lo DCs — no carrier backbone or path-aware networking' }, verdict: 'apex-better' },
      ],
      prosCons: [
        { product: 'ApexAegis', pros: ['All-in-one SSE + SD-WAN', 'NextGenNodes partnership — 428 PoPs in 362 cities, 148 Tbps backbone capacity', 'AegisRoute™ path-aware networking — built from scratch on Apexphalanx, cryptographic path verification, sovereign isolation domains', 'Modern QUIC/MASQUE tunnel over Apexphalanx-secured MPLS backbone', 'Microsegmentation + attack paths built-in', 'Single license covers all features', 'Post-quantum encryption ready (CRYSTALS-Kyber) on AegisRoute™ sovereign ring'], cons: ['CASB catalog: accelerated via Cloud Security Alliance STAR registry + CSA STAR catalog partnership (40k+ apps)', 'Newer in market — rapidly scaling via NextGenNodes global infrastructure with 428 PoPs operational'] },
