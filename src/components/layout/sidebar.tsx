...
const navGroups: NavGroup[] = [
  ...
  {
    label: 'Unified AI Telemetry & Ledger',
    items: [
  ...
  },
  {
    ...
    items: [
      ...
      { href: '/profiles/dns', icon: Network, label: 'DNS Filter', featureId: 'dns-filter', premium: true },
      { href: '/profiles/web', icon: AlertTriangle, label: 'Web Filter', featureId: 'web-filter' },
      { href: '/profiles/device-posture-profile', icon: Smartphone, label: 'Device Posture' },
    ],
  },
  {
    label: 'Security Posture & Validation',
    items: [
      { href: '/security', icon: GitBranch, label: 'Attack Paths', premium: true },
      { href: '/security/ai-ueba', icon: Brain, label: 'AI/UEBA', featureId: 'ueba', premium: true },
      ...
      { href: '/ghosted-apps', icon: Ghost, label: 'Shadow IT Discovery', featureId: 'ghosted-apps' },
    ],
  },
  {
  ...
  },
  {
    ...
    items: [
      ...
      { href: '/compliance/certifications', icon: Award, label: 'Certifications', premium: true },
