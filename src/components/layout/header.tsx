...
const demoNotifications: Notification[] = [
  ...
  { id: 'n3', type: 'critical', title: 'DRKey Session Failure', message: 'ISD-202 (DBS Bank) DRKey derivation timed out — Apexphalanx peering degraded.', time: '45 min ago', read: false },
  ...
  { id: 'n5', type: 'success', title: 'Gateway Node Online', message: 'NextGenNodes SG-03 is now operational. Latency: 1.2ms.', time: '2 hr ago', read: true },
